window.EROS_DATA = {
  ...
  "goon": {
    ...
    "carry_forward_reason": "Current refresh did not produce a usable live GOON signal; retaining the previous aggregate instead of replacing it with demo data."
  },
  "refresh_errors": [
    "CDC marriage rate: HTTP Error 403: Forbidden",
    "CDC fertility rate: HTTP Error 403: Forbidden",
    "Tranco GOON pulse: The read operation timed out",
    "GOON: retained previous live aggregate because the current refresh was incomplete."
  ],
